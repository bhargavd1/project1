 ...
 *
 * @param manifestUI5 - SAPUI5 manifest data.
 * @param app - Project application.
 * @param pageName - Page name which should be used to apply FCL.
 * @param targetPages - Current array of target pages to join in.
 ...
 *
 * @param sapui5 - SAPUI5 manifest data.
 */
