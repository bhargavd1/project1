 ...
 */
export declare function generateObjectPageInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: Manifest, fragments?: FileData[], flex?: string[], logger?: ExtensionLogger): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateListReportInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: Manifest, fragments?: FileData[], flex?: string[], logger?: ExtensionLogger): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateAnalyticalListPageInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: Manifest, fragments?: FileData[], flex?: string[], logger?: ExtensionLogger): object;
/**
