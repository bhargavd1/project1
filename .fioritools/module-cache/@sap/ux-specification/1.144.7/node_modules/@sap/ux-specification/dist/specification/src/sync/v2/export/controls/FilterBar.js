...
exports.ListReportFilterBar = exports.AnalyticalListPageFilterBar = exports.CommonFilterBar = exports.SelectionFields = exports.SelectionFieldDateSettings = exports.DefaultDateRange = exports.DateRange = void 0;
...
/**
 * Get specific fields from the date settings in the manifest section.
 *
 * @param manifestSection - The manifest section containing the date settings.
 * @param _sectionId - The section ID (currently unused, required as this function is assigned to the sync rule see interface ManifestConverter).
 * @param propertyKey - The key of the property to import.
