...
import type { ObjectPageSectionData, Manifest, ExtensionLogger, CommonImportParameters } from '@sap/ux-specification-types';
 ...
 */
export declare function addFragments(config: LROPConfigsType, importParameters: CommonImportParameters, v2Page: v2.SapUiAppPageV2, pageType: PageTypeV2, objectPageSectionData?: ObjectPageSectionData, lineItemsId?: string): void;
/**
