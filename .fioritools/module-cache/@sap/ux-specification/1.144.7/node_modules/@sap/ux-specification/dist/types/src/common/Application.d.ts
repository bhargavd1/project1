 ...
 * @internal true
 */
export declare enum CloudDevAdaptationStatus {
    Released = "released",
...
export interface CommonAppSettings {
    /**
     * Defines the title for the application.
     *
     * @i18nClassification TIT: Title of the application
     */
    title?: string;
    /**
     * Defines the description for the application.
     *
     * @i18nClassification TIT: Description of the application
     */
    description?: string;
    /**
     * Enables key user adaptation for an application.
     *
