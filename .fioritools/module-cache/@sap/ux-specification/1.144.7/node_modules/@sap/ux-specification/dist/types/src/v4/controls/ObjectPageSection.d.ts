...
export interface CustomSections {
     ...
     * @isViewNode true
     */
    [key: string]: ObjectPageCustomSectionFragment | ObjectPageEmbeddedComponentSection;
}
...
/**
 * Embedded Component Section (e.g. HDM attachment reuse)
 *
 * @isViewNode true
 */
export interface ObjectPageEmbeddedComponentSection extends Omit<ObjectPageCustomSectionBase, 'id' | 'type' | 'className'> {
    /**
     * Embedded component: Its name is the library name.
     *
     * @artifactType Manifest
     */
    embeddedComponent: {
    ...
    /**
     * SAP Object Node Type used by the reuse component.
     *
     * @artifactType Manifest
     */
    sapObjectNodeType: string;
    /**
     * Linked Object Key used by the reuse component.
     *
     * @artifactType Manifest
     */
    linkedObjectKey: string;
    /**
     * Edit mode binding (computed — not user editable).
     *
     * @artifactType Manifest
     */
    mode?: string;
    /**
     * Fiori ID of the app (computed — not user editable).
     *
     * @artifactType Manifest
     */
    fioriId?: string;
    /**
     * App ID (computed — not user editable).
     *
     * @artifactType Manifest
     */
    appId?: string;
    /**
     * Object page ID (computed — not user editable).
     *
     * @artifactType Manifest
     */
    objectPageId?: string;
