...
exports.generateFreestyleSchemaV4 = generateFreestyleSchemaV4;
/**
 * Generates an app specific schema for the FE V4 Freestyle page from the generic schema.
 * Generic types are replaced by information from the app specific annotations.
 *
 * @param _generateParameters - list of API input parameters
 ...
 */
function generateFreestyleSchemaV4(_generateParameters, genericSchema) {
    return JSON.parse(JSON.stringify(genericSchema));
}
//# sourceMappingURL=freestylePage.js.map