...
import type { ExtensionLogger, SchemaDefinition } from '@sap/ux-specification-types';
 ...
 */
export declare function generateMacrosSchemaDefinition(genericSchema: SchemaDefinition, xmlFile: ExtensionFileData, serviceAVT: ConvertedMetadata, logger?: ExtensionLogger): SchemaDefinition | undefined;
