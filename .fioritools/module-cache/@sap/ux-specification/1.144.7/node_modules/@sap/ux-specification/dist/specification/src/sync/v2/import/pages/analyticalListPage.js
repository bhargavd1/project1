 ...
 * @param analyticalListPageConfig - the configuration to be filled
 * @param factory - factory, for generating the access to reflect-metadata
 * @param pageKey - key of the page in manifest
 */
...
/**
 * Generates the configuration file content for an analytical list page V2.
 *
 * @param importParameters - Object containing all input data.
 * @returns {v2.AnalyticalListPageConfigV2 | undefined} - The generated configuration as JSON or undefined if no pages are found.
 */
function createAnalyticalListPageConfig(importParameters) {
    // Initialize i18next
    (0, i18n_1.initI18n)();
    // Filter flex changes which are relevant only for page
    importParameters = {
        ...importParameters,
        flex: (0, utils_1.filterFlexChanges)(importParameters.flex, ux_specification_types_1.v2.SAPUI5_VIEW_EXTENSION_ANALYTICAL_LIST_PAGE, importParameters.entitySet)
    };
