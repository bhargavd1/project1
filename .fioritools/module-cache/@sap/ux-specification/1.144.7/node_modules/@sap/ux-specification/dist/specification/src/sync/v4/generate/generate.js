 ...
 * @param {boolean} isCapService - indicates whether the service is a CAP service
 * @returns the app specific JSON schema
 */
function generateObjectPageInterfaceV4(genericSchema, entitySetName, annotations, manifest, logger, fragments, contextPath, genericMacrosSchema, featureToggles, isCapService) {
 ...
 * @param {ExtensionLogger} logger - Logger class for logging messages
 * @param manifest - manifest.json of the app
 * @param contextPath - the context path of the actual page
 * @param {boolean} isCapService - indicates whether the service is a CAP service
 * @returns the app specific JSON schema
 */
function generateListReportInterfaceV4(templateType, genericSchema, entitySetName, annotations, logger, manifest, contextPath, isCapService) {
    (0, i18n_1.initI18n)();
    const serviceAVT = (0, utils_1.parseAndMergeAndConvert)(annotations, logger);
    const { entitySet, entityType } = (0, importProject_1.getEntityTypeEntitySetFromContextPath)(serviceAVT, contextPath, entitySetName, logger);
    const generateParameters = {
 ...
 * Generic types are replaced by information from the app specific annotations.
 *
 * @param templateType - the template type allows distinguishing LR and ALP
 * @param genericSchema - generic JSON schema of a list report
 * @param annotations - list of all annotation files (file content plus URI as identifier)
 * @param manifest - manifest.json of the app
 * @param _entitySetName - the name of the entity set (optional)
 ...
 *
 * @param genericSchema - generic JSON schema of a list report.
 * @param routingId - page id in routing.
 * @param manifest - manifest.json of the app.
 * @param views - array of views.xml files.
 * @param annotations - list of all annotation files (file content plus URI as identifier)
 * @param [featureToggles] - array of supported features.
 * @param [logger] - Logger class for logging messages.
 * @returns the app specific JSON schema.
 */
