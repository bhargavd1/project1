 ...
 * @param {string[]} _idBreadcrumbs Array of breadcrumbs used for ID generation
 ...
 *
 * @param {string} baseId Base Id of the control
 * @param {string[]} _idBreadcrumbs Array of breadcrumbs used for intermediate ID generation
 * @param {string[]} breadcrumbs Array of breadcrumb strings used for stable ID generation
 * @returns {string} stable ID of Action button
 */
