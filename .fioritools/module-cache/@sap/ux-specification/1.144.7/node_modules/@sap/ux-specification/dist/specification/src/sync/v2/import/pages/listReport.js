 ...
 *
 * @param importParameters  - object comprising all input data
 * @param listReportConfig - the configuration to be filled
 * @param factory - factory, for generating the access to reflect-metadata
 * @param pageKey - key of the page in manifest
 */
...
function createListReportConfig(importParameters) {
    ...
    importParameters = {
        ...importParameters,
        flex: (0, utils_1.filterFlexChanges)(importParameters.flex, ux_specification_types_1.v2.SAPUI5_VIEW_EXTENSION_LIST_REPORT, importParameters.entitySet)
    };
    ...
    (0, index_1.addFragments)(config, importParameters, v2Page, ux_specification_types_1.PageTypeV2.ListReport);
