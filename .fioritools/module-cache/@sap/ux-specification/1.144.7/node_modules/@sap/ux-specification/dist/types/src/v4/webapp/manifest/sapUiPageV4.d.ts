...
export interface ObjectPageAttachmentSectionSettings {
    mode?: string;
...
/**
 * Section based on an embedded reuse component (e.g. the HDM attachment reuse component).
 * The name references a key defined under sap.ui5/componentUsages.
 */
export interface SapUi5RoutingTargetContentEmbeddedComponentSection {
    title: string;
    position?: SapUi5RoutingTargetContentPosition;
    embeddedComponent: {
        name: string;
        settings?: ObjectPageAttachmentSectionSettings;
    };
}
...
export interface SapUi5RoutingTargetContentSections {
    [key: string]: SapUi5RoutingTargetContentSection | SapUi5RoutingTargetContentSubSectionsWrapper | SapUi5RoutingTargetContentEmbeddedComponentSection;
}
