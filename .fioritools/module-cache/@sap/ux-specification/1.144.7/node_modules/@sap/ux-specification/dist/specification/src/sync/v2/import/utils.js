...
exports.checkV2Page = checkV2Page;
...
exports.flexChangeMatchesTemplateAndEntitySet = flexChangeMatchesTemplateAndEntitySet;
exports.filterFlexChanges = filterFlexChanges;
 ...
 */
function getV2Pages(importParameters) {
 ...
 */
function checkV2Page(v2Page, logger, entitySet) {
    if (!v2Page) {
        (0, extensionLogger_1.log)(logger, {
            severity: "error" /* LogSeverity.Error */,
            message: i18next_1.default.t('NOPAGEFORENTITYSET', { entitySet }),
            location: {
                path: ux_specification_types_1.MANIFESTPATH,
                range: [ux_specification_types_1.ManifestSection.generic]
            }
    ...
    if (!v2Page.entitySet) {
        ...
        (0, extensionLogger_1.log)(logger, {
            severity: "error" /* LogSeverity.Error */,
            message: i18next_1.default.t('NOENTITYSET', { pageName }),
            location: {
                path: ux_specification_types_1.MANIFESTPATH,
                range: [ux_specification_types_1.ManifestSection.generic]
            }
 ...
 */
function flexChangeMatchesTemplateAndEntitySet(change, template, entitySet) {
    const controlIdParts = change?.controlId?.split('--') ?? [];
    return controlIdParts[0]?.endsWith(`::${template}::${entitySet}`) ?? false;
}
/**
 ...
 */
function filterFlexChanges(flex, template, entitySet) {
    return flex.filter((changeStr) => {
        const change = (0, common_1.parseChangeString)(changeStr);
        return flexChangeMatchesTemplateAndEntitySet(change, template, entitySet);
    });
}
