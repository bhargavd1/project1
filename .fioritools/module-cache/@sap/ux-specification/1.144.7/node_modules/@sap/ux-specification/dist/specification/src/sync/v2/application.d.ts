import type { TableColumnVerticalAlignment, StatePreservationMode, DraftDiscardConfirmationSettings, Target, Application, FlexibleColumnLayout, Manifest, CloudDevAdaptationStatus } from '@sap/ux-specification-types';
...
export declare const getCardSettingsPath: (cardKeys: string[]) => string;
...
export declare const getGlobalTableSettingsPathV2: (pageKeys: string[]) => string;
...
export declare class AppSettings implements v2.AppSettings {
    ...
    globalTableSettings?: v2.GlobalApplicationTableSettings;
}
