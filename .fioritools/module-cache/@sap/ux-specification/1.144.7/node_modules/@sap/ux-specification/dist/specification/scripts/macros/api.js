...
exports.getLatestNpmVersion = void 0;
exports.getMacrosAPI = getMacrosAPI;
const fs_1 = __importDefault(require("fs"));
const semver_1 = require("semver");
const axios_1 = __importDefault(require("axios"));
const path_1 = require("path");
const PACKAGENAME = '@sap/ux-specification';
/**
...
async function isLatestVersion(specVersion) {
    ...
    if (specVersion === '9.9.9') {
        ...
        const latestReleaseSpecVersion = await (0, exports.getLatestNpmVersion)(PACKAGENAME);
        if (latestReleaseSpecVersion) {
            const coerceLatestReleasedSpecVersion = (0, semver_1.coerce)(latestReleaseSpecVersion);
            return ui5Version.major === 1 && ui5Version.minor >= coerceLatestReleasedSpecVersion.minor;
        }
    }
    return false;
}
