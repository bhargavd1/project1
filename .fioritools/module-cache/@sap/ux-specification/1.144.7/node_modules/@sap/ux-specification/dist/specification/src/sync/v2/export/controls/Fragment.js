...
function getFragmentNamespaces(fragment, isCoreFragmentDefinition) {
    ...
    if (fragmentAttributes) {
        ...
        throw new Error('Invalid fragment, please check content');
    }
}
/**
 ...
 * @param tag.namespace - The namespace of the tag
 * @param tag.name - The name of the tag
 * @param fragmentNamespaces namespaces of fragment
 ...
 * @param configColumns - list of all columns in the config
 * @returns - boolean value indicating if the column was found in the config
 */
    ...
    for (const fragment of fragments) {
        ...
        if (fragmentPathArray[fragmentPathArray.length - 1] === fragmentName) {
            ...
            try {
                ...
                throw new Error(`Invalid fragment ${fragment['dataSourceUri']}, please check content`);
            }
            break;
        }
    }
...
/**
 * Processes custom columns in an array.
 *
 * @param columnsInFragmentDefinition - Existing columns definition in the fragment.
 * @param configColumns - Custom columns configuration object.
 */
...
/**
 * Maintains existing columns in a fragment by updating or removing them based on the provided configuration.
 *
 * @param columnsInFragmentDefinition - Existing columns definition in the fragment.
 * @param configColumns - Custom columns configuration object.
 * @param fragmentJson - JSON representation of the fragment.
 * @returns Updated columns definition in the fragment.
 */
 ...
 *
 * @param page Page object from manifest.
 * @param entitySet Table's entity set.
 * @param [additionalKey] Key provided when defining the FacetID or QuickVariantSelectionX.
 * @param [tableColumnExtensionType] Column extension type.
 * @returns Path to the column extension in the manifest.
 */
