 ...
 *
 * @param selectorIdParts - Parts of the selector ID split by '::'
 * @param facetID - The facet ID to be determined
 ...
 *
 * @param changes - Array of flex change strings to be processed
 * @param entitySet - The entity set associated with the object page
 * @param logger - Optional logger instance for logging errors or warnings
...
function prepareFlexChanges(changes, entitySet, logger) {
    ...
    changes.forEach((changeString) => {
        try {
            ...
            if (change &&
                (0, utils_1.flexChangeMatchesTemplateAndEntitySet)(change, ux_specification_types_1.v2.SAPUI5_VIEW_EXTENSION_OBJECT_PAGE, entitySet)) {
 ...
 * @returns - type of section, differentiated by level (Sub/Section)
 */
 ...
 * @param lineItemsDefinition - generic line items definition in the app schema
 ...
 * @param deprecatedProperties - list od deprecated properties
 * @param sectionPart - structure comprising the section information
 * @returns {object} - the section in the manifest
 */
 ...
 * @param importTypeId - type of action that was be initiated
 * @param facetId - The ID of the facet to be used for importing flex changes
 ...
 * @param configParameters - Object containing configuration parameters such as page keys, flex changes, and factory instance
 */
 ...
 *
 * @param importParameters - object comprising all input data
 * @param sectionPart - current properties' list of form section
 * @param fieldProperties - current properties' list (of fields)
 * @param configPart - the given part of the object page config
 * @param configParameters - container for factory, pageKeys, flexChanges, v2Page, ObjectPageConfig
 */
 ...
 * @param configPart - the given part of the object page config, to be filled
 * @param v2Page - v2 page from manifest.
 * @param sectionId - ID of the given section
 */
 ...
 *
 * @param importParameters  - object comprising all input data
 * @param sectionPart - current properties' list of chart section
 ...
 *
 * @param importParameters - object comprising all input data
 * @param sectionPart - current properties' list of subsection
 * @param manifestSettings - object page settings section of the manifest
 * @param configPart - the given part of the object page config
 * @param configParameters - container for factory, pageKeys, flexChanges, v2Page, ObjectPageConfig
 */
 ...
 *
 * @param customSections - list of custom sections, as defined in manifest
 * @param objectPageConfig - the object page configuration (JSON)
 * @param configParameters - object comprising input for filling the config
 * @param schemaDefinitions - definitions in the object page schema
 * @param importParameters  - object comprising API input data
 */
...
/**
 * Fill properties of object page config based on manifest settings.
 *
 * @param importParameters  - object comprising API input data
 * @param configParameters - object comprising input for filling the config
 * @returns - the object page configuration (JSON)
 */
